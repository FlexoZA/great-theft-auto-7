...
- Core files (`main.lua`, `src/net/`, `src/states/`, `src/state.lua`, `src/ui.lua`, `src/car.lua`) are shared. Only change them when a feature genuinely needs a new hook, keep the change minimal, and call it out in the pull request.
