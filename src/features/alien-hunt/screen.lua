-- The full-screen portrait the hunt puts up when someone has something to
-- say: a face over turning rays on the right, and a column on the left with
-- a small heading, a big title, a line under it and what they say, in a
-- speech bubble pointing at them. Laid out like Karen's title screen.
